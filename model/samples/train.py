...
#     return mse.compute(predictions=eval_pred.predictions, references=eval_pred.label_ids, squared=False)
...
def parse_arguments() :
    ...
    parser.add_argument('--data_dir', type=str, default="./data/text_with_features.csv")
